import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { ref, computed, unref, provide, inject as inject$1, toRef, hasInjectionContext, getCurrentInstance as getCurrentInstance$1, toValue, useId, shallowRef, toRaw, readonly, watch, onScopeDispose, warn, reactive, watchEffect, Fragment, defineComponent as defineComponent$1, capitalize, createVNode, mergeProps, createElementVNode, effectScope, createElementBlock, cloneVNode, h, normalizeClass, defineAsyncComponent, shallowReactive, normalizeStyle, createApp, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, getCurrentScope, withCtx, Suspense, nextTick, isReadonly, useSSRContext, isRef, isShallow, isReactive, toRefs } from 'vue';
import { o as hasProtocol, p as isScriptProtocol, r as joinURL, B as withQuery, t as parseURL, h as encodePath, d as decodePath, v as sanitizeStatusCode, j as getContext, $ as $fetch, f as defu, a as createHooks, c as createError$1, i as executeAsync } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-DAfXmh_l.mjs')
  },
  {
    name: "cuentas",
    path: "/cuentas",
    component: () => import('./cuentas-FaBmd9UT.mjs')
  },
  {
    name: "movimientos",
    path: "/movimientos",
    component: () => import('./movimientos-DMj-f1-n.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-Bv99VZXP.mjs').then((m) => m.default || m))
};
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(VApp, _attrs, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_NuxtLayout, null, null, _parent2, _scopeId));
      } else {
        return [
          createVNode(_component_NuxtLayout)
        ];
      }
    }),
    _: 1
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-D37kodWU.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-kkR4rLSF.mjs'));
...
export { useRouter as $, makeDisplayProps as A, makeLayoutItemProps as B, makeThemeProps as C, navigateTo as D, EventProp as E, nuxtLinkDefaults as F, omit as G, onlyDefinedProps as H, IconValue as I, parseColor as J, pickWithRest as K, LayoutMetaSymbol as L, propsFactory as M, provideDefaults as N, provideTheme as O, PREFERS_REDUCED_MOTION as P, resolveRouteObject as Q, tryUseNuxtApp as R, useDisplay as S, useIcon as T, useLayoutItem as U, useLocale as V, useNuxtApp as W, useProxiedModel as X, useRender as Y, useResizeObserver as Z, _export_sfc as _, PageRouteSymbol as a, useRtl as a0, useRuntimeConfig as a1, useTheme as a2, useToggleScope as a3, wrapInArray as a4, consoleError as b, clamp as c, consoleWarn as d, entry_default as default, convertToUnit as e, defer as f, defineComponent as g, deprecate as h, destructComputed as i, encodeRoutePath as j, filterInputAttrs as k, findChildrenWithProvide as l, flattenFragments as m, focusChild as n, genericComponent as o, getCurrentInstance as p, getCurrentInstanceName as q, getPropertyFromItem as r, hasEvent as s, hasLightForeground as t, includes as u, isCssColor as v, isObject as w, isParsableColor as x, isPrimitive as y, makeComponentProps as z };

import { _ as __nuxt_component_0 } from './nuxt-link-Dm9bEy0m.mjs';
...
import { Chart, Title, Tooltip, Legend, LineElement, PointElement, CategoryScale, LinearScale, ArcElement, BarElement } from 'chart.js';
  ...
  setup(__props) {
    ...
    const series = computed(() => {
      ...
      for (const t of props.transactions) {
        ...
        const cur = (_a = byMonth.get(key)) != null ? _a : { income: 0, expense: 0 };
      ...
      for (const key of lastKeys) {
        ...
        const y = Number(yStr);
        const m = Number(mStr);
        const neto = ((_c = (_b = byMonth.get(key)) == null ? void 0 : _b.income) != null ? _c : 0) - ((_e = (_d = byMonth.get(key)) == null ? void 0 : _d.expense) != null ? _e : 0);
        acc += neto;
        ...
        plugins: {
          ...
          tooltip: {
            callbacks: {
              label: (ctx) => {
                var _a;
                return formatCOP(Number((_a = ctx.parsed.y) != null ? _a : 0));
              }
            }
          }
        },
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "wrap" }, _attrs))} data-v-4277d579><div class="header" data-v-4277d579><h3 class="title" data-v-4277d579>Evoluci\xF3n del saldo</h3><div class="meta" data-v-4277d579>\xDAltimos ${ssrInterpolate(series.value.labels.length)} meses</div></div><div class="chartBox" data-v-4277d579>`);
  ...
  setup(__props) {
    ...
    const series = computed(() => {
      ...
      for (const key of lastKeys) {
        ...
        const monthLabel = new Date(y, m - 1, 1).toLocaleDateString("es-CO", { month: "short", year: "2-digit" });
        labels.push(monthLabel);
        income.push((_c = (_b = byMonth.get(key)) == null ? void 0 : _b.income) != null ? _c : 0);
        expense.push((_e = (_d = byMonth.get(key)) == null ? void 0 : _d.expense) != null ? _e : 0);
      }
        ...
        plugins: {
          ...
          tooltip: {
            callbacks: {
              label: (ctx) => {
                var _a;
                const v = Number((_a = ctx.parsed.y) != null ? _a : 0);
  ...
  setup(__props) {
    ...
    const grouped = computed(() => {
      ...
      for (const t of expenses) {
        const key = (t.category || "Sin categor\xEDa").trim();
        byCat.set(key, ((_a = byCat.get(key)) != null ? _a : 0) + t.amount);
      }
    ...
    const legendItems = computed(() => {
      ...
      return grouped.value.labels.map((label, idx) => {
        var _a;
        const value = (_a = grouped.value.values[idx]) != null ? _a : 0;
        ...
        plugins: {
          ...
          tooltip: {
            callbacks: {
              label: (ctx) => {
                var _a, _b;
                const value = Number((_a = ctx.parsed) != null ? _a : 0);
                const label = (_b = ctx.label) != null ? _b : "";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "wrap" }, _attrs))} data-v-0cdf8b55><div class="header" data-v-0cdf8b55><h3 class="title" data-v-0cdf8b55>Gastos por categor\xEDa</h3></div><div class="chartBox" data-v-0cdf8b55>`);
  ...
  async setup(__props) {
    ...
    const moneyToday = computed(() => {
      return accounts.value.reduce((acc, a) => {
        var _a;
        return acc + ((_a = a.balance) != null ? _a : 0);
      }, 0);
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div></section><section class="rowBottom" data-v-bf91f0eb><div class="card" data-v-bf91f0eb><div class="cardHeader" data-v-bf91f0eb><h2 class="sectionTitle" data-v-bf91f0eb>\xDAltimos movimientos</h2><div class="muted" data-v-bf91f0eb>${ssrInterpolate(lastMovements.value.length)}/5</div></div>`);
      if (loading.value) {
        _push(`<div class="muted" data-v-bf91f0eb>Cargando...</div>`);
      } else {
        _push(`<div class="table" data-v-bf91f0eb><div class="thead" data-v-bf91f0eb><div data-v-bf91f0eb>Tipo</div><div data-v-bf91f0eb>Categor\xEDa</div><div class="right" data-v-bf91f0eb>Monto</div><div class="right" data-v-bf91f0eb>Fecha</div></div><!--[-->`);
...
//# sourceMappingURL=index-DAfXmh_l.mjs.map

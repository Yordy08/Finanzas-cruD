import { defineComponent, provide, shallowReactive, h, ref, inject, Suspense, Fragment, computed, mergeProps, withCtx, createVNode, toDisplayString, useSSRContext, resolveComponent, createTextVNode, withDirectives, vShow, resolveDynamicComponent, openBlock, createBlock, renderList } from "vue";
import { RouterView, useRoute } from "vue-router";
import { P as PageRouteSymbol, u as useNuxtApp, L as LayoutMetaSymbol, c as useRuntimeConfig, _ as _export_sfc } from "../server.mjs";
...
import { _ as __nuxt_component_0$1 } from "./nuxt-link-B9HvlfGR.js";
...
const _imports_0 = "" + __buildAssetsURL("logo.liNYndMy.png");
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  __name: "AppNavbar",
  __ssrInlineRender: true,
  setup(__props) {
    const appName = computed(() => {
      return useRuntimeConfig().public?.appName || "Finanzas";
    });
...
//# sourceMappingURL=default-DLTlT_H-.js.map

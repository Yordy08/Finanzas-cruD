...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></select></label></div><div class="row" data-v-a3d3b7bc><label class="label" data-v-a3d3b7bc> Categoría <input${ssrRenderAttr("value", form.category)} class="input" placeholder="Ej: Comida" data-v-a3d3b7bc></label><label class="label" data-v-a3d3b7bc> Monto <input${ssrRenderAttr("value", form.amount)} type="number" min="0" step="0.01" class="input" data-v-a3d3b7bc></label></div><label class="label" data-v-a3d3b7bc> Descripción (opcional) <input${ssrRenderAttr("value", form.description)} class="input" placeholder="Ej: Mercado, Taxi, etc." data-v-a3d3b7bc></label><div class="actions" data-v-a3d3b7bc><button class="btn" type="submit"${ssrIncludeBooleanAttr(loading.value || accountsSafe.value.length === 0) ? " disabled" : ""} data-v-a3d3b7bc>${ssrInterpolate(loading.value ? "Guardando..." : "Guardar")}</button></div>`);
      if (error.value) {
...
//# sourceMappingURL=TransactionForm-CynYsPvV.js.map

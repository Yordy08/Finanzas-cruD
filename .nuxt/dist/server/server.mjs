import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance as getCurrentInstance$1, inject as inject$1, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent as defineComponent$1, createElementBlock, provide, cloneVNode, h, warn, capitalize, watchEffect, Fragment, ref, computed, unref, createVNode, normalizeClass, mergeProps, createElementVNode, toValue, watch, onScopeDispose, toRefs, readonly, useId, defineAsyncComponent, Suspense, nextTick, normalizeStyle, withCtx, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "C:/Users/Yordy/Finanzas-cruD/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "C:/Users/Yordy/Finanzas-cruD/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/Users/Yordy/Finanzas-cruD/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "C:/Users/Yordy/Finanzas-cruD/node_modules/h3/dist/index.mjs";
import { shouldHydrate, setActivePinia, createPinia } from "pinia";
import { defu } from "C:/Users/Yordy/Finanzas-cruD/node_modules/defu/dist/defu.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1 } from "vue-router";
import { hasProtocol, joinURL, parseURL, encodePath, decodePath, withQuery, isScriptProtocol } from "C:/Users/Yordy/Finanzas-cruD/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-DAfXmh_l.js")
  },
  {
    name: "cuentas",
    path: "/cuentas",
    component: () => import("./_nuxt/cuentas-FaBmd9UT.js")
  },
  {
    name: "movimientos",
    path: "/movimientos",
    component: () => import("./_nuxt/movimientos-DMj-f1-n.js")
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-Bv99VZXP.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-D37kodWU.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-kkR4rLSF.js"));
...
export {
  useRouter as $,
  makeDisplayProps as A,
  makeLayoutItemProps as B,
  makeThemeProps as C,
  navigateTo as D,
  EventProp as E,
  nuxtLinkDefaults as F,
  omit as G,
  onlyDefinedProps as H,
  IconValue as I,
  parseColor as J,
  pickWithRest as K,
  LayoutMetaSymbol as L,
  propsFactory as M,
  provideDefaults as N,
  provideTheme as O,
  PREFERS_REDUCED_MOTION as P,
  resolveRouteObject as Q,
  tryUseNuxtApp as R,
  useDisplay as S,
  useIcon as T,
  useLayoutItem as U,
  useLocale as V,
  useNuxtApp as W,
  useProxiedModel as X,
  useRender as Y,
  useResizeObserver as Z,
  _export_sfc as _,
  PageRouteSymbol as a,
  useRtl as a0,
  useRuntimeConfig as a1,
  useTheme as a2,
  useToggleScope as a3,
  wrapInArray as a4,
  consoleError as b,
  clamp as c,
  consoleWarn as d,
  ...
  deprecate as h,
  destructComputed as i,
  encodeRoutePath as j,
  filterInputAttrs as k,
  findChildrenWithProvide as l,
  flattenFragments as m,
  focusChild as n,
  genericComponent as o,
  getCurrentInstance as p,
  getCurrentInstanceName as q,
  getPropertyFromItem as r,
  hasEvent as s,
  hasLightForeground as t,
  includes as u,
  isCssColor as v,
  isObject as w,
  isParsableColor as x,
  isPrimitive as y,
  makeComponentProps as z
};
